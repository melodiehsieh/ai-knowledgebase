...
cursor.execute("USE DATABASE [db_here]")
cursor.execute("USE SCHEMA [schema_here]")
cursor.execute("SELECT NAME, TITLE, PAGE_ID, PAGE_BODY FROM [table_here]")
...
collection_name = "qdrant_confluence_db"
...
vector_store = QdrantVectorStore(collection_name="qdrant_confluence_db", client=qdrant_client, dense_vector_name="custom_vector", sparse_vector_name="custom_vector")
